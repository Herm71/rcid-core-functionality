...
/**
 * Print the Google Tag Manager container snippet in the document head.
 *
 * Hooked at priority -1 so it lands as high in <head> as possible.
 *
 * @return void
 */
...
/**
 * Print the Google Tag Manager noscript fallback immediately after <body>.
 *
 * Hooked at priority -1 so it lands as high in the body as possible.
 *
 * @return void
 */
